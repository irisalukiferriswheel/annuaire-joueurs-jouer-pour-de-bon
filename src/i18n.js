export const copy = {
  fr: {
    ...
    heroTextBasic: 'Cherchez des joueurs réels par ville ou jeu. Les statistiques, causes, disponibilités et avis apparaîtront à mesure que les profils publics seront enrichis.',
    ...
    noMatchesHelpBasic: 'Essayez un autre nom, une autre ville ou un autre jeu.',
    ...
    about: 'À propos de',
    profileDetailsPending: 'Les statistiques, causes, disponibilités et informations communautaires de ce profil ne sont pas encore publiées.',
    locationNotListed: 'Ville non indiquée',
  ...
  en: {
    ...
    heroTextBasic: 'Search real players by city or game. Statistics, causes, availability and reviews will appear as public profiles gain those verified fields.',
    ...
    noMatchesHelpBasic: 'Try another name, city or game.',
    ...
    about: 'About',
    profileDetailsPending: 'Statistics, causes, availability and community information have not yet been published for this profile.',
    locationNotListed: 'City not listed',
